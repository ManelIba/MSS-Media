          ...
          <div class="stories">
            ...
            <div class="stories__content">
              <button class="story story--has-story">
                ...
                <span class="story__user">x.xsarah</span>
              </button>
              <button class="story story--has-story">
                <div class="story__avatar">
                  <div class="story__border">
                ...
                <span class="story__user">el_manel</span>
              </button>
              <button class="story story--has-story">
                <div class="story__avatar">
                  <div class="story__border">
                ...
                <span class="story__user">ayeman</span>
              </button>
              <button class="story">
                <div class="story__avatar">
                  <div class="story__border">
                ...
                <span class="story__user">sou_d</span>
              </button>
              <button class="story">
                <div class="story__avatar">
                  <div class="story__border">
                ...
                <span class="story__user">selenophil</span>
              </button>
              <button class="story">
                <div class="story__avatar">
                  <div class="story__border">
                ...
                <span class="story__user">Celanie</span>
              </button>
              <button class="story">
                <div class="story__avatar">
                  <div class="story__border">
                ...
                <span class="story__user">MoonLovers</span>
              </button>
              <button class="story">
                <div class="story__avatar">
                  <div class="story__border">
                ...
                <span class="story__user">food's.world</span>
              </button>
              <button class="story">
                <div class="story__avatar">
                  <div class="story__border">
                ...
                <span class="story__user">Selena Gomize</span>
              </button>
              <button class="story">
                <div class="story__avatar">
                  <div class="story__border">
                ...
                <span class="story__user">snai3i</span>
              </button>
              <button class="story">
                <div class="story__avatar">
                  <div class="story__border">
          ...
          <div class="posts">
              ...
              <div class="post__footer">
                ...
                <div class="post__infos">
                  <div class="post__likes">
                    ...
                    <span
                      >Liked by
                      <a class="post__name--underline" href="#">palestine</a> and
                      <a href="#">710,345others</a></span
                    >
                  </div>
                  ...
                  <div class="post__description">
                    <span>
                      <a
                        ...
                        >Palestinnian</a
                      >
                      فِلَـٓسَـٓــِٰٓطٓـيَنَُ 𓂆      I STAND WITH PALESTINE  ﮩ٨ـﮩﮩ٨ـ♡ﮩ٨ـﮩﮩ٨ـ
                       Free Free Palestine  🍉𓂆فلسطين🇵🇸🕊️ 
                    </span>
                  </div>
              ...
              <div class="post__header">
                <div class="post__profile">
                  <a href="#" class="post__avatar">
                    <img src="assets/user2.jpg" alt="User Picture" />
                  </a>
                  <a href="#" class="post__user">Mari_.na</a>
                </div>
              ...
              <div class="post__footer">
                ...
                <div class="post__infos">
                  <div class="post__likes">
                    ...
                    <span
                      >Liked by
                      <a class="post__name--underline" href="#">ayeman</a> and
                      <a href="#">4 others</a></span
                    >
                  </div>

                  <div class="post__description">
                    <span>
                      <a class="post__name--underline" href="#">Mari_.na</a>
                      🐚🥥🦀🌊   Summer vibes 🌴🍹🍉⛱️🥥
                    </span>
                  </div>
            ...
            <article class="post">
              <div class="post__header">
                <div class="post__profile">
                  <a href="#" class="post__avatar">
                    <img src="assets/ayeman.jpg" alt="User Picture" />
                  </a>
                  <a href="#" class="post__user">aymane</a>
                </div>
              ...
              <div class="post__footer">
                ...
                <div class="post__infos">
                  ...
                  <div class="post__description">
                    <span>
                      <a class="post__name--underline" href="#">aymane</a>
                      Business vibes 🃜 🃚 🃖 🃁 🂭 🂺
                    </span>
                  </div>
            ...
            <article class="post">
              <div class="post__header">
                <div class="post__profile">
                  <a href="#" class="post__avatar">
                    <img src="assets/user3.jpg" alt="User Picture" />
                  </a>
                  <a href="#" class="post__user">x_x.sarah</a>
                </div>
              ...
              <div class="post__content">
                <div class="post__medias">
                  <img
                    class="post__media"
                    src="assets/cheescake.png"
                    alt="Post Content"
                  />
                  <img
                    class="post__media"
                    src="assets/gufre.png"
                    alt="Post Content"
                  />
                  <img
                    class="post__media"
              ...
              <div class="post__footer">
                ...
                <div class="post__infos">
                  <div class="post__likes">
                    ...
                    <span
                      >Liked by
                      <a class="post__name--underline" href="#">el_manel</a> and
                      <a href="#">15 others</a></span
                    >
                  </div>

                  <div class="post__description">
                    <span>
                      <a class="post__name--underline" href="#">x_x.sarah</a>
                      ༼ つ ◕_◕ ༽つ🍰🍔🍕      food is my therapy       (*ᴗ͈ˬᴗ͈)ꕤ*.ﾟ
                    </span>
                  </div>
            ...
            <article class="post">
              <div class="post__header">
                <div class="post__profile">
                  <a href="#" class="post__avatar">
                    <img src="assets/thired.jpg" alt="User Picture" />
                  </a>
                  <a href="#" class="post__user">el_manel</a>
                </div>
              ...
              <div class="post__footer">
                ...
                <div class="post__infos">
                  <div class="post__likes">
                    <a href="#" class="post__likes-avatar">
                      <img src="assets/thired.png" alt="User Picture" />
                    </a>

                    <span
                      >Liked by
                      <a class="post__name--underline" href="#">senophile</a> and
                      <a href="#">73 others</a></span
                    >
                  </div>
                  ...
                  <div class="post__description">
                    <span>
                      <a class="post__name--underline" href="#">el_manel</a>
                      ⋆˖⁺‧₊☽◯☾₊‧⁺˖⋆   Moon always remind me of u 🌕 ᥫ᭡ 
                    </span>
                  </div>
