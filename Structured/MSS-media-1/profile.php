        ...
        <div class="profile-header">
           <div ><img src="<?php echo  $usereimg ; ?>" class="img"></div>
            <div class="profile-info">
                ...
                <div class="profile-Adminname">@<?php echo $useremail; ?></div>
      ...
      <section class="content-container">
        <div class="content">
          ...
          <?php while ($row_info = mysqli_fetch_assoc($info)) {
                 ...
                 $_SESSION['Post_Id'] = $row_info['Post_Id'];
                 $PostId = $_SESSION['Post_Id'];

                   $que = "SELECT * FROM `comments` WHERE `Post_ID`='$PostId'";
                   $comments_result = mysqli_query($conn, $que);
                   $row_infocc = mysqli_fetch_assoc( $comments_result);

                   $Q = " SELECT * FROM `likes` WHERE `Post_Id`= '$PostId'";
                   $F= mysqli_query($conn,$Q);
                   $row_count = mysqli_num_rows($F);
             ?>         
