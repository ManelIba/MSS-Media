  ...
  <body>
    <header class="header">
      <nav class="header__content">
        <div class="header__buttons">
          <h2 class="header_home" style= "color: pink ; font-family:'Brush Script MT',' Brush Script Std', 'cursive';">MSS<span style= "color: gray" >Media</span></h2>
    ...
    >
        <path
            fill-rule="evenodd"
            clip-rule="evenodd"
            d="M18 4H6C4.897 4 4 4.897 4 6V18C4 19.103 4.897 20 6 20H18C19.103 20 20 19.103 20 18V6C20 4.897 19.103 4 18 4ZM18 18H6V6H18V18ZM12.707 14.707L11.293 13.293L14.586 10H8V8H14.586L11.293 4.707L12.707 3.293L17.414 8L12.707 12.707V14.707Z"
            fill="var(--text-dark)"
        />
    </svg>
          </a>
