...
<html lang="en">
 ...
 while ($row_info = mysqli_fetch_assoc($info)) { 
  ...
  $userimg=$row_info['img'];
  $userbio=$row_info['Bio'];
  ?>
                ...
                <div class="story__avatar">
                        <div class="story__border">
                          ...
                          <div class="story__picture">
                              <img src="<?php echo  $userimg ; ?>" class="PetiteImg">
                          </div>
                      </div>
                           <span class="story__user"><?php echo $username ?></span>
                 </button>
...
<section class="side-menu">
          ...
          <div class="side-menu__user-profile">
               <a target="_blank"  class="side-menu__user-avatar" >
                   <img src="<?php echo  $_SESSION['Userimg'] ; ?>" class="PetiteImg"> 
               </a>
         

          <div class="side-menu__user-info">
                <a href="profile.php"  ><?php echo $_SESSION['UserName'] ?></a >
                <span> <?php echo $_SESSION['Userbio'] ?></span>
          </div> 
